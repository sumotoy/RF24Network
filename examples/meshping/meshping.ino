...
bool send_N(uint16_t to)
{
  ...
  Serial.print("---------------------------------\n\r");
  Serial.print(millis());
  Serial.print(": APP Sending active nodes to 0");
  Serial.print(to);
  Serial.print("...\n\r");
...
void handle_T(RF24NetworkHeader& header)
{
  ...
  if (header.from_node != this_node || header.from_node > 00) add_node(header.from_node);
}
...
void handle_N(RF24NetworkHeader& header)
{
  ...
  Serial.print(millis());
  Serial.print(": APP Received nodes from 0");
  Serial.print(header.from_node);
  Serial.print("\n\r");
  int i = 0;
...
void add_node(uint16_t node)
{
  ...
  if (i == -1 && num_active_nodes < max_active_nodes)
  {
    ...
    Serial.print(millis());
    Serial.print(": APP Added 0");
    Serial.print(node);
    Serial.print(" to list of active nodes.\n\r");
